...
#ifndef CPP_LAUNCH__ACTIONS__GROUP_ACTION_HPP_
#define CPP_LAUNCH__ACTIONS__GROUP_ACTION_HPP_
...
class GroupAction final : public Action
{
 public:
  ...
  explicit GroupAction(const Options& options);
...
#endif  // CPP_LAUNCH__ACTIONS__GROUP_ACTION_HPP_
